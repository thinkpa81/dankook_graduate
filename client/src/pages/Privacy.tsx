        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-medium text-blue-100">Privacy Policy</span>
            </div>
            <h1 className="text-4xl lg:text-5xl font-black mb-4">개인정보처리방침</h1>
          ...
          <Card className="border-0 shadow-xl rounded-3xl overflow-hidden">
            <CardContent className="p-8 lg:p-12">
              <div className="flex items-center gap-4 mb-8 pb-6 border-b">
                ...
                <div>
                  <h2 className="text-xl font-bold text-foreground">개인정보처리방침</h2>
                  <p className="text-muted-foreground text-sm">시행일자: 2026년 3월 1일</p>
                </div>
              </div>
              ...
              <div className="prose prose-slate max-w-none">
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-gradient-to-r from-amber-500/5 to-transparent p-6 rounded-2xl">
                    <h3 className="text-xl font-bold text-foreground mb-4">
                  ...
                  <div className="bg-gradient-to-r from-emerald-500/5 to-transparent p-6 rounded-2xl">
                    <h3 className="text-xl font-bold text-foreground mb-4">
                      제5조 (개인정보의 파기)
                    </h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  <div className="bg-gradient-to-r from-purple-500/5 to-transparent p-6 rounded-2xl">
                    <h3 className="text-xl font-bold text-foreground mb-4">
                      제7조 (개인정보의 안전성 확보 조치)
                    </h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  <div className="p-6">
                    ...
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-border">
                      <p className="text-foreground font-bold mb-2">개인정보 보호책임자</p>
                  ...
                  <div className="bg-gradient-to-r from-rose-500/5 to-transparent p-6 rounded-2xl">
                    <h3 className="text-xl font-bold text-foreground mb-4">
                      제9조 (개인정보처리방침 변경)
                    </h3>
                    <p className="text-muted-foreground leading-relaxed">
