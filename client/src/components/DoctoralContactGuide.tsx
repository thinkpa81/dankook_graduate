...
export default function DoctoralContactGuide() {
  return (
    <section
      className="border-t border-slate-200 bg-white px-6 py-8 sm:px-8 lg:px-10 lg:py-10"
    ...
    >
      <div className="max-w-4xl">
        ...
        <ol className="mt-8 divide-y divide-slate-200 border-y border-slate-200">
          <li className="grid gap-4 py-6 md:grid-cols-[180px_minmax(0,1fr)] md:gap-8">
            <div>
              <span className="text-xs font-bold tracking-[0.12em] text-[#2156D9]">STEP 01</span>
            ...
            <div className="space-y-4 text-[15px] leading-7 text-slate-700">
              <p>
                ...
                <a
                  ...
                  className="font-semibold text-[#2156D9] underline-offset-4 hover:underline"
                >
                  {professorEmail}
                </a>
                )
              ...
              <div className="rounded-md border border-blue-100 bg-blue-50/70 px-4 py-3">
                ...
                <p className="mt-1 text-sm text-slate-500">예: [박사과정 지원 문의] 홍길동_2027년 전기</p>
              </div>
              <p>
              ...
              <a
                href={`mailto:${professorEmail}?subject=${inquirySubject}`}
                className="inline-flex min-h-11 items-center gap-2 rounded-md bg-[#2156D9] px-5 py-2.5 font-bold text-white transition-colors hover:bg-[#1848bc] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#2156D9]"
              >
          ...
          <li className="grid gap-4 py-6 md:grid-cols-[180px_minmax(0,1fr)] md:gap-8">
            <div>
              <span className="text-xs font-bold tracking-[0.12em] text-[#2156D9]">STEP 02</span>
            ...
            <div className="text-[15px] leading-7 text-slate-700">
              <ul className="space-y-3" aria-label="필수 첨부 서류 목록">
                ...
                <li className="flex items-start gap-3">
                  <Paperclip className="mt-1.5 h-4 w-4 shrink-0 text-slate-400" aria-hidden="true" />
                  <p>
                    <strong className="font-bold text-slate-900">자기소개 및 관심 연구 분야</strong>: 본 연구실의 어떤
                    프로젝트에 관심이 있는지 A4 1장 내외로 간략히 작성해 주세요. 이메일 본문에 직접 작성하거나
                    PDF 파일로 첨부할 수 있습니다.
                  </p>
                </li>
              </ul>
          ...
          <li className="grid gap-4 py-6 md:grid-cols-[180px_minmax(0,1fr)] md:gap-8">
            <div>
              <span className="text-xs font-bold tracking-[0.12em] text-[#2156D9]">STEP 03</span>
            ...
            <div className="space-y-3 text-[15px] leading-7 text-slate-700">
              ...
              <p>
                관련 문의는 랩실 대표 이메일
                {" "}
                <a href="mailto:yubinlove@hotmail.com" className="font-semibold text-[#2156D9] underline-offset-4 hover:underline">
                  yubinlove@hotmail.com
                </a>
                {" "}또는{" "}
                <a href="mailto:thinkpa@naver.com" className="font-semibold text-[#2156D9] underline-offset-4 hover:underline">
                  thinkpa@naver.com
                </a>
                로 편하게 연락해 주시기 바랍니다.
              </p>
