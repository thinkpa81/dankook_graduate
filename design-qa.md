...
- Reference sources:
  ...
  - 지도교수 연구관심분야 3열: `/workspace/scratch/8305753068ce/upload/c52a6034-bf57-496d-9cb8-bc18ae87745e.png`
...
- 연구관심분야 10개는 데스크톱에서 3열(각 열 약 219px)로 배치되고 긴 항목도 잘리지 않는다.
...
- 연구관심분야는 요청한 10개 항목이 모두 표시되고 CSS `grid-template-columns`가 3개 열로 계산된다.
