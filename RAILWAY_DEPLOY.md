...
> **폐기된 대체 플랫폼 문서:** 현재 운영 대상은 Render입니다. 아래 명령과 기능 목록은 현행 운영 절차가 아니며 `git add .` 또는 비밀값을 포함한 CLI 명령을 실행하지 마십시오. 최신 절차는 `RENDER_DEPLOY.md`와 `docs/SECURITY_OPERATIONS.md`를 사용합니다.
